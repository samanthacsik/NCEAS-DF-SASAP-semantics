...
SDI_attributes_all <- rbind(SDI_SASAP_attributes, SDI_replicated_query) %>% 
  ...
  mutate(
    update_id = case_when(
      ...
      identifier == "urn:uuid:1646fd83-e7b8-4876-b695-333dd6d6675b" ~ "004",
      identifier == "urn:uuid:379f256c-b3d5-4f66-a76f-a982a2538c59" ~ "005",
      identifier == "urn:uuid:22464585-00e2-4be2-8ef0-75a2ebc6bcb3" ~ "006"
    )
  ) %>% 
  mutate(
    update_id_description = case_when(
      ...
      identifier == "urn:uuid:1646fd83-e7b8-4876-b695-333dd6d6675b" ~ "BCO-DMO 2009",
      identifier == "urn:uuid:379f256c-b3d5-4f66-a76f-a982a2538c59" ~ "Malick 2015",
      identifier == "urn:uuid:22464585-00e2-4be2-8ef0-75a2ebc6bcb3" ~ "Bell 2021"
    )
  ) %>% 
  ...
  mutate(
    new_identifier = case_when(
      ...
      original_identifier == "urn:uuid:1646fd83-e7b8-4876-b695-333dd6d6675b" ~ "urn:uuid:1646fd83-e7b8-4876-b695-333dd6d6675b",
      original_identifier == "urn:uuid:379f256c-b3d5-4f66-a76f-a982a2538c59" ~ "urn:uuid:379f256c-b3d5-4f66-a76f-a982a2538c59",
      original_identifier == "urn:uuid:22464585-00e2-4be2-8ef0-75a2ebc6bcb3" ~ "urn:uuid:22464585-00e2-4be2-8ef0-75a2ebc6bcb3"
    )
  ) %>% 

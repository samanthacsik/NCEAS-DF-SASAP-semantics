...
# attribute 12, species = chinook, chum, coho, pink, sockeye (+ others)
...
##############################
# dataTable 7 (LocationTableApril2017.csv) 
##############################
...
# attribute 9, Species = chinook, chum, coho, pink, sockeye (+ others)

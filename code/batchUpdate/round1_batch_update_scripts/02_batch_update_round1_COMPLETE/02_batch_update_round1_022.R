...
# title: batch update of datapackages with semantic annotations -- ROUND 1, 022 (ASL PWC and Copper River)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (PWS_CopperRiver.csv)
#-----------------------------

# attribute 9, species = sockeye, chum, coho, chinook
...
# attribute 11, length = mid-eye to fork of tail, post-orbit to fork of tail, mid-eye to hypural plate, fork length, mid-eye to posterior insertion of anal fin
...
doc$dataset$dataTable[[1]]$attributeList$attribute[[11]]$annotation <- list(
  ...
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
       valueURI = list(label = "Mid-orbit to posterior insertion of anal fin length", valueURI = "http://purl.dataone.org/odo/salmon_000132"))
)
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_022.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1FF3QMV
# new metadata pid: doi:10.5063/M61HPN
# old rm: resource_map_doi:10.5063/F1FF3QMV
# new rm: resource_map_doi:10.5063/M61HPN
# Alaska Department of Fish and Game, Division of Commercial Fisheries. 2018. Salmon age, sex, and length data from Lower Cook Inlet, Alaska, 1961-2014. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 032 (ASL Lower Cook Inlet)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ASL_formatted_LowerCookInlet.csv) 
#-----------------------------

# attribute 6, Species = sockeye, chum, coho, chinook
doc$dataset$dataTable$attributeList$attribute[[6]]$id <- "dataTable1_spp"
doc$dataset$dataTable$attributeList$attribute[[6]]$annotation <- list(
...
# attribute 8, Length = 
doc$dataset$dataTable$attributeList$attribute[[8]]$id <- "dataTable1_length"
doc$dataset$dataTable$attributeList$attribute[[8]]$annotation <- list(
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_032.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1NV9GHW
# new metadata pid: doi:10.5063/707ZV2
# old rm: resource_map_doi:10.5063/F1NV9GHW
# new rm: resource_map_doi:10.5063/707ZV2
...
# attribute 12
doc$dataset$dataTable$attributeList$attribute[[12]]$id <- NULL
doc$dataset$dataTable$attributeList$attribute[[12]]$annotation <- NULL
...
old_new_PIDs <- data.frame(
  old_metadataPID = "doi:10.5063/707ZV2",
  old_resource_map = "resource_map_doi:10.5063/707ZV2",
  new_metadataPID = "doi:10.5063/NV9GNP",
  new_resource_map = "resource_map_doi:10.5063/NV9GNP"
)

# Stephanie Freund and Jeanette Clark. 2018. Coho salmon brood tables, northeast Pacific, 1967-2015. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 035 (Coho brood tables, northeast Pacific)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (CohoBroodTables_TotalAge.csv) 
#-----------------------------

# attribute 2, Species = coho
...
#-----------------------------
# dataTable 2 (CohoBroodTables_FW_SW_Age.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 3 (StockInfo_Coho.csv) 
#-----------------------------
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_035.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1SF2TG1
# new metadata pid: doi:10.5063/ZG6QNF
# old rm: resource_map_doi:10.5063/F1SF2TG1
# new rm: resource_map_doi:10.5063/ZG6QNF
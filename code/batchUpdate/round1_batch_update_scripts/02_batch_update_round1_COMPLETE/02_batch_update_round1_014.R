# Jeanette Clark and Stephanie Freund. 2018. Chinook salmon brood tables, northeast Pacific, 1976-2015. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 014 (Chinook brood tables northeast Pacific)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ChinookBroodTables_TotalAge.csv) 
#-----------------------------

# attribute 2, Species = chinook
...
#-----------------------------
# dataTable 2 (ChinookBroodTables_FW_SW_Age.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 3 (StockInfo_Chinook.csv) 
#-----------------------------

# attribute 2, Species = chinook
doc$dataset$dataTable[[3]]$attributeList$attribute[[2]]$id <- "dataTable3_spp"
doc$dataset$dataTable[[3]]$attributeList$attribute[[2]]$annotation <- list(
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
       valueURI = list(label = "Chinook salmon", valueURI = "http://purl.dataone.org/odo/salmon_000239"))
)
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_014.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F11Z42Q5
# new metadata pid: doi:10.5063/80511P
# old rm: resource_map_doi:10.5063/F11Z42Q5
# new rm: resource_map_doi:10.5063/80511P
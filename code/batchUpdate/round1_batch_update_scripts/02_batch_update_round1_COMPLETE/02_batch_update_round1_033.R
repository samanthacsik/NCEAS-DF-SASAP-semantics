# Alaska Department of Fish and Game, Division of Commercial Fisheries, Central Region. 2017. Sockeye salmon brood tables, Bristol Bay, Alaska, 1955-2016. Knowledge Network for Biocomplexity. 
...
#-----------------------------
# dataTable 1 (Naknek_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 2 (Egegik_sockeye.csv)
#-----------------------------
...
#-----------------------------
# dataTable 3 (Kvichak_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 4 (Ugashik_sockeye.csv)
#-----------------------------
...
#-----------------------------
# dataTable 5 (Alagnak_sockeye.csv)
#-----------------------------
...
#-----------------------------
# dataTable 6 (Togiak_sockeye.csv)
#-----------------------------
...
#-----------------------------
# dataTable 8 (Nushagak_sockeye.csv)
#-----------------------------
...
#-----------------------------
# dataTable 9 (Igushik_sockeye.csv)
#-----------------------------
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_033.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1NZ85X6
# new metadata pid: doi:10.5063/K35S22
# old rm: resource_map_doi:10.5063/F1NZ85X6
# new rm: resource_map_doi:10.5063/K35S22
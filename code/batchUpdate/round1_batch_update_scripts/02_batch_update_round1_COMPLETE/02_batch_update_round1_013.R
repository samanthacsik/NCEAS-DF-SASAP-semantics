# Alaska Department of Fish and Game, Division of Commercial Fisheries, Southeast Region and Bert Lewis. Chinook salmon age, sex, and length data from major rivers in Southeast Alaska, 1988-2017. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 013 (Chinook ASL from major rivers Southeast AK)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ASL_formatted_SoutheastSupplement.csv) 
#-----------------------------

# attribute 4, Species = chinook
doc$dataset$dataTable$attributeList$attribute[[4]]$id <- "dataTable1_spp"
doc$dataset$dataTable$attributeList$attribute[[4]]$annotation <- list(
...
# attribute , Length = mid-eye to fork of tail (abstract: "generally from mid-eye to fork of tail")
doc$dataset$dataTable$attributeList$attribute[[6]]$id <- "dataTable1_length"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_013.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F11R6NSS
# new metadata pid: doi:10.5063/416VFG
# old rm: resource_map_doi:10.5063/F11R6NSS
# new rm: resource_map_doi:10.5063/416VFG
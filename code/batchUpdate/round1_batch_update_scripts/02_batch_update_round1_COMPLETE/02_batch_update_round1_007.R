# Rich Brenner, Greg Ruggerone, Brendan Connors, Jeanette Clark, and Stephanie Freund. 2017. Sockeye salmon brood tables, northeastern Pacific, 1922-2016. Knowledge Network for Biocomplexity. doi:10.5063/F1891459.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 007 (Sockeye brood tables 1922-2016)
# author: "Sam Csik"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_007.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1891459
# new metadata pid: doi:10.5063/CR5RR9
# old rm: resource_map_urn:uuid:e414a9a6-ec17-4587-be60-35f9d7e8a210
# new rm: resource_map_doi:10.5063/CR5RR9

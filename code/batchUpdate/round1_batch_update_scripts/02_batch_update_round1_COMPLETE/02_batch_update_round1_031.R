# Jared Kibele and Leslie Jones. 2017. Historic air temperatures in Alaska for 1901-2015, with spatial subsetting by region. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 031 (Historic air temperatures 1901-2015)
# author: "Sam Csik"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_031.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1MK6B60
# new metadata pid: doi:10.5063/7S7M5W
# old rm: resource_map_doi:10.5063/F1MK6B60
# new rm: resource_map_doi:10.5063/7S7M5W
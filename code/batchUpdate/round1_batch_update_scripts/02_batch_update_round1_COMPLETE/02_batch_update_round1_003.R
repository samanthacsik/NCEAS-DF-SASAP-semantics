# Alaska Department of Fish and Game, Division of Commercial Fisheries. 2018. Daily escapement counts, Bristol Bay, Alaska, 1955-2017. Knowledge Network for Biocomplexity.

# NOTE: had originally removed 'Location' to figure out if we should use ECSO or Salmon URI (there are definitely other pkgs like this that I haven't made note of)

# title: batch update of datapackages with semantic annotations -- ROUND 1, 003 (ADF&G Daily Escapement Bristol Bay)
# author: "Sam Csik"
...
attributes <- round1_003 %>% 
  filter(!attributeName %in% c("Species")) %>% # decide whether to keep or remove 'Location'
...
#-----------------------------
# dataTable 1 (Cunningham_BristolBay.csv) 
#-----------------------------

# attribute 6, Species = sockeye
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_003.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F14Q7S94
# new metadata pid: doi:10.5063/HD7T35
# old rm: resource_map_doi:10.5063/F14Q7S94
# new rm: resource_map_doi:10.5063/HD7T35

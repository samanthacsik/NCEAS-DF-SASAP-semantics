# Richard Alexander. 2018. Sockeye Salmon Brood Tables, Meziadin, British Columbia, 1972-2017. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 021 (Sockeye brood tables, Meziadin, BC)
# author: "Sam Csik"
...
# old metadata pid: doi:10.5063/F1DF6PHX

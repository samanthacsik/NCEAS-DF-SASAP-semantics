# Alaska Department of Fish and Game, Division of Commercial Fisheries, Southeast Region. 2018. Sockeye salmon brood tables, PWS and Southeast, Alaska, 1958-2016. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 004 (ADF&G Sockeye brood tables PWS & Southeast AK)
# author: "Sam Csik"
...
# -------------------------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------------------------
# ANNOTATE BY HAND -- AT ENTITY LEVEL????????
# -------------------------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------------------------
...
#-----------------------------
# dataTable 1 (Chilkoot_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 2 (Coghill_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 3 (Copper_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 4 (Eshamy_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 5 (Redoubt_sockeye.csv) 
#-----------------------------
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_004.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1513WHZ
# new metadata pid: doi:10.5063/FJ2F78
# old rm: resource_map_doi:10.5063/F1513WHZ
# new rm: resource_map_doi:10.5063/FJ2F78
...
# update predicate after further discussion with Mark
...
old_new_PIDs <- data.frame(
  old_metadataPID = "doi:10.5063/FJ2F78",
  old_resource_map = "doi:10.5063/9S1PG3",
  new_metadataPID = "resource_map_doi:10.5063/9S1PG3",
  new_resource_map = "resource_map_doi:10.5063/FJ2F78"
)
...
# recreate table
old_new_PIDs <- data.frame(
  old_metadataPID = "doi:10.5063/9S1PG3",
  old_resource_map = "resource_map_doi:10.5063/9S1PG3",
  new_metadataPID = "doi:10.5063/M32T6F",
  new_resource_map = "resource_map_doi:10.5063/M32T6F"
)

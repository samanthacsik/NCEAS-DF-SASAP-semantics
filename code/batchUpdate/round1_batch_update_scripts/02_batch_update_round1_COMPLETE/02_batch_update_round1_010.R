# Jeanette Clark and Rich Brenner. 2017. Compiled statewide Alaskan daily salmon escapement counts, 1922-2017. Knowledge Network for Biocomplexity. 

# title: batch update of datapackages with semantic annotations -- ROUND 1, 010 (Compiled daily escapement counts 1922-2017)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (Escapement_location_linked.csv) 
#-----------------------------

# attribute 2, Species = sockeye, pink, coho, chinook, steelhead trout, dolly varden (general) cutthroat trout (general), unknown salmon, dolly varden (anadromous), sheefish (inconnu), whitefish (broad), whitefish (least cisco), whitefish (humpback), arctic char
doc$dataset$dataTable[[1]]$attributeList$attribute[[2]]$id <- "dataTable1_spp"
doc$dataset$dataTable[[1]]$attributeList$attribute[[2]]$annotation <- list(
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_010.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F19K48HN
# new metadata pid: doi:10.5063/28061R
# old rm: resource_map_doi:10.5063/F19K48HN
# new rm: resource_map_doi:10.5063/28061R
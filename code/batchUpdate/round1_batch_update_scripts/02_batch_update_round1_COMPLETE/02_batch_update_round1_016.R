# Alaska Department of Fish and Game, Division of Commercial Fisheries. 2017. Daily salmon escapement counts, Central Region, Alaska. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 016 (Daily escapement, Central Region)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (Central_region_20170517.csv) 
#-----------------------------

# attribute , Species = chinook, chum, coho, pink, sockeye, mixed
...
#-----------------------------
# dataTable 2 (centralRegion2011to2017.csv) 
#-----------------------------

# attribute 1, Species = chinook, chum, coho, pink, sockeye, mixed
doc$dataset$dataTable[[2]]$attributeList$attribute[[1]]$id <- "dataTable2_spp"
doc$dataset$dataTable[[2]]$attributeList$attribute[[1]]$annotation <- list(
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
       valueURI = list(label = "Chum salmon", valueURI = "http://purl.dataone.org/odo/salmon_000240")),
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
       valueURI = list(label = "Sockeye salmon", valueURI = "http://purl.dataone.org/odo/salmon_000242")),
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_016.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1319T59
# new metadata pid: doi:10.5063/0G3HK7
# old rm: resource_map_doi:10.5063/F1319T59
# new rm: resource_map_doi:10.5063/0G3HK7
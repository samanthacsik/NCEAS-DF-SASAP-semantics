# Jeanette Clark, Rich Brenner, and Stephanie Freund. 2018. Compiled annual statewide Alaskan salmon escapement counts, 1921-2017.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 008 (salmon escapement counts 1921-2017)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (CompiledEsc.csv) 
#-----------------------------

# attribute 1, Species = dolly varden (anadromous), chinook, chum, coho, cutthroat trout (general), dolly varden (general), pink, sheefish, sockeye, steelhead trout, unknown salmon, whitefish (broad), whitefish (humpback), whitefish (least cisco), chinook, dolly varden, arctic char
doc$dataset$dataTable[[1]]$attributeList$attribute[[1]]$id <- "dataTable1_spp"
doc$dataset$dataTable[[1]]$attributeList$attribute[[1]]$annotation <- list(
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_008.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F18G8J0D
# new metadata pid: doi:10.5063/610XRP
# old rm: resource_map_doi:10.5063/F18G8J0D
# new rm: resource_map_doi:10.5063/610XRP

# Jeanette Clark and Robyn Thiessen-Bock. Estimate of total Alaskan salmon abundance by region, 2000-2015. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 019 (Estimate of total salmon abundance 2000-2015)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (salmon-abundance_mean-cumulative-annual-count_by-region.csv) 
#-----------------------------

# attribute 2, species = chinook, chum, coho, pink, sockeye
doc$dataset$dataTable$attributeList$attribute[[2]]$id <- "dataTable1_species"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_019.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1BR8QG4
# new metadata pid: doi:10.5063/QV3JZW
# old rm: resource_map_doi:10.5063/F1BR8QG4
# new rm: resource_map_doi:10.5063/QV3JZW
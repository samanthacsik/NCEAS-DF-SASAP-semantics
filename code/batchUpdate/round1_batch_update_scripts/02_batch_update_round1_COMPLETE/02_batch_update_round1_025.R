# Andrew Munro and Eric Volk. 2017. Summary of Pacific Salmon Escapement Goals in Alaska with a Review of Escapements from 2007 to 2015.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 025 (Summary of Escapement Goals)
# author: "Sam Csik"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_025.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1GX48V4
# new metadata pid: doi:10.5063/BR8QMX
# old rm: resource_map_doi:10.5063/F1GX48V4
# new rm: resource_map_doi:10.5063/BR8QMX
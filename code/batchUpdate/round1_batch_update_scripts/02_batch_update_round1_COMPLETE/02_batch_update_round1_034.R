# Rich Brenner and Steve Moffitt. 2018. Pink salmon age, sex, and length data from Prince William Sound, Alaska, 1997-2016. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 034 (Pink ASL from PWS)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ASL_formatted_PrinceWilliamSoundpinks.csv) 
#-----------------------------

# attribute 13, Species = sockeye
doc$dataset$dataTable$attributeList$attribute[[13]]$id <- "dataTable1_spp"
...
# attribute 8, Length = mid-eye to fork of tail length
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_034.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1PR7T8D
# new metadata pid: doi:10.5063/377744
# old rm: resource_map_doi:10.5063/F1PR7T8D
# new rm: resource_map_doi:10.5063/377744
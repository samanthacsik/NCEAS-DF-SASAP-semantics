...
old_new_PIDs <- data.frame(
  old_metadataPID = "doi:10.5063/J964T6",
  old_resource_map = "resource_map_doi:10.5063/J964T6",
  new_metadataPID = "doi:10.5063/6T0K12",
  new_resource_map = "resource_map_doi:10.5063/6T0K12"
)

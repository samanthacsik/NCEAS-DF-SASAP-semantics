# Alaska Department of Fish and Game, Division of Commercial Fisheries. 2017. Daily salmon escapement counts from the OceanAK database, Alaska, 1921-2017. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 038 (Daily escapement counts from OceanAK)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ADFG_Salmon_Escapement_First_Attempt.csv) 
#-----------------------------

# attribute 4, Species = sockeye, pink, coho, chinook, steelhead trout (up), chum, steelhead trout (down), steelhead trout, dolly varden (general), chum (summer), cutthroat trout (general), sockeye (late run), chum (fall), dolly varden (anadromous), sheefish (inconnu), whitefish (broad), whitefish (least cisco), whitefish (humpback)
doc$dataset$dataTable[[1]]$attributeList$attribute[[4]]$id <- "dataTable1_species"
...
#-----------------------------
# dataTable 2 (ADFG_firstAttempt_reformatted.csv) 
#-----------------------------

# attribute 4, Species = sockeye, pink, coho, chinook, steelhead trout (up), chum, steelhead trout (down), steelhead trout, dolly varden (general), chum (summer), cutthroat trout (general), sockeye (late run), chum (fall), dolly varden (anadromous), sheefish (inconnu), whitefish (broad), whitefish (least cisco), whitefish (humpback)
doc$dataset$dataTable[[2]]$attributeList$attribute[[4]]$id <- "dataTable2_species"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_038.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1VT1QB1
# new metadata pid: doi:10.5063/P26WJJ
# old rm: resource_map_doi:10.5063/F1VT1QB1
# new rm: resource_map_doi:10.5063/P26WJJ
# Alaska Department of Fish and Game, Division of Commercial Fisheries, Central Region. 2018. Salmon age, sex, and length data from Upper Cook Inlet, Alaska, 1967-2016. 

# title: batch update of datapackages with semantic annotations -- ROUND 1, 015 (ASL Upper Cook Inlet)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ASL_formatted_UpperCookInlet.csv) 
#-----------------------------

# attribute 4, Species = chinook, chum, coho, pink and sockeye (found in Abstract)
...
# attribute 5, Length = mid-eye to fork of tail (abstract: "generally from mid-eye to fork of tail")
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_015.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1222S1G
# new metadata pid: doi:10.5063/513WM9
# old rm: resource_map_doi:10.5063/F1222S1G
# new rm: resource_map_doi:10.5063/513WM9
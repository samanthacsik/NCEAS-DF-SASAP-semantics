# Alaska Department of Fish and Game, Division of Commercial Fisheries, Central Region. 2015. Salmon age, sex, and length data from Bristol Bay region of Alaska, 2010-2015. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 039 (ASL Bristol Bay 2010-2015)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (ASL_bristol_bay_full.csv) 
#-----------------------------

# attribute 5, Species = chinook, chum, sockeye
doc$dataset$dataTable[[1]]$attributeList$attribute[[5]]$id <- "dataTable1_species"
...
# attribute 11, Length = mid-eye to fork of tail length, post-orbit to fork of tail length, fork length
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_039.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1W957GP

# Andrew Munro and Eric Volk. 2018. Summary of Pacific Salmon Escapement Goals in Alaska with a Review of Escapements from 2001 to 2009. Knowledge Network for Biocomplexity.
# title: batch update of datapackages with semantic annotations -- ROUND 1, 001 (Munro & Volk 2018)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (MandV2010.csv) 
#-----------------------------

# attribute 2, Species = Chinook, Chum, Coho, Sockeye, Pink
doc$dataset$dataTable$attributeList$attribute[[2]]$id <- "dataTable1_spp"
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_001.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1416VB4
# new metadata pid: doi:10.5063/639N5V
# old rm: resource_map_doi:10.5063/F1416VB4
# new rm: resource_map_doi:10.5063/639N5V

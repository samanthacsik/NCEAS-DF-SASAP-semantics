# NEEDS ANNOTATIONS AT ENTITY LEVEL

# title: batch update of datapackages with semantic annotations -- ROUND 1, 017 ()
# author: "Sam Csik"
...
attributes <- round1_017 %>% 
  filter(!attributeName %in% c("Total all 3 species")) %>% 
  drop_na(assigned_valueURI) %>% 
  filter(prefName != "tbd") # !!! check on this
# -----------------------------------------------
...
#-----------------------------
# dataTable 3 (Enhanced-ret_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 10 (Nat-origin-ret_pink.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 11 (Nat-origin-ret_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 14 (Total-biom-mat-plus-young_pink.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 15 (Total-biom-mat-plus-young_sock.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 18 (Total-ret-biomass_pink.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 19 (Total-ret-biomass_sockeye.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 22 (Total-ret_pink.csv) 
#-----------------------------
...
#-----------------------------
# dataTable 23 (Total-ret_sockeye.csv) 
#-----------------------------
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_017.csv"))
# ------------------------------------------------

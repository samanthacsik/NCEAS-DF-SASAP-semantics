# Alaska Department of Fish and Game, Division of Commercial Fisheries, Central Region and Neala Kendall. 2018. Salmon age, sex, and length data from Bristol Bay, Alaska, 1957-2009. Knowledge Network for Biocomplexity.
...
#-----------------------------
# dataTable 1 (ASL_formatted_BristolBay.csv) 
#-----------------------------
...
# attribute 5, Length = mid-orbit to fork of tail length, fork length, post-orbit to fork of tail length
doc$dataset$dataTable[[1]]$attributeList$attribute[[5]]$id <- "dataTable1_length"
...
#-----------------------------
# dataTable 2 (ASL_unformatted_BristolBay.csv) ; don't annotate spp or length
#-----------------------------
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_005.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F15T3HRG
# new metadata pid: doi:10.5063/CJ8BW6
# old rm: resource_map_doi:10.5063/F15T3HRG
# new rm: resource_map_doi:10.5063/CJ8BW6

# Alaska Department of Fish and Game, Division of Commercial Fisheries, Central Region. 2018. Chinook age, sex, and length data from East Side Cook Inlet, Alaska, 1970-2012. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 009 (Chonook ASL, East Side Cook Inlet)
# author: "Sam Csik"
...
# attribute 14, Length = mid-eye to fork of tail
doc$dataset$dataTable$attributeList$attribute[[14]]$id <- "dataTable1_length"
doc$dataset$dataTable$attributeList$attribute[[14]]$annotation <- list(
  list(propertyURI = list(label = "contains measurements of type", propertyURI = containsMeasurementsofType),
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_009.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F18K77BT
# new metadata pid: doi:10.5063/RX99HF
# old rm: resource_map_doi:10.5063/F18K77BT
# new rm: resource_map_doi:10.5063/RX99HF
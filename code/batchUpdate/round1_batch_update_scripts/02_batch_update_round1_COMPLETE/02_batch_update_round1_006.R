# Alaska Department of Fish and Game, Division of Commercial Fisheries, Arctic-Yukon-Kuskokwim Region. Salmon escapement data from Arcic-Yukon-Kusokwim Region, 1965-2015. Knowledge Network for Biocomplexity.

# title: batch update of datapackages with semantic annotations -- ROUND 1, 006 (ADF&G escapement AYK)
# author: "Sam Csik"
...
#-----------------------------
# dataTable 1 (AYKDBMS.csv) 
#-----------------------------

# attribute 2, Species = chinook, chum, coho, sockeye, pink, dolly varden (general), arctic char, dolly varden (anadromous), unknown salmon
doc$dataset$dataTable$attributeList$attribute[[2]]$id <- "dataTable2_spp"
doc$dataset$dataTable$attributeList$attribute[[2]]$annotation <- list(
...
write_csv(old_new_PIDs, here::here("data", "updated_pkgs", "round1", "round1_006.csv"))
# ------------------------------------------------


# old metadata pid: doi:10.5063/F1610XMW
# new metadata pid: doi:10.5063/K935ZK
# old rm: resource_map_doi:10.5063/F1610XMW
# new rm: resource_map_doi:10.5063/K935ZK

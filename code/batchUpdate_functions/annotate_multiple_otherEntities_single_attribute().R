annotate_multiple_otherEntities_single_attribute <- function(doc, entity_num, current_attribute_id, attributeName_subset){
  ...
  # doc$dataset$otherEntity[[entity_num]]$attributeList$attribute$annotation$propertyURI <- list(label = "contains measurements of",
  ...
  doc$dataset$otherEntity[[entity_num]]$attributeList$attribute$annotation$propertyURI <- list(label = current_propertyLabel,

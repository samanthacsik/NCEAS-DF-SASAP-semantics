annotate_single_dataTable_single_attribute <- function(doc, current_attribute_id, attributeName_subset){
  ...
  # doc$dataset$dataTable$attributeList$attribute$annotation$propertyURI <- list(label = "contains measurements of",
  ...
  doc$dataset$dataTable$attributeList$attribute$annotation$propertyURI <- list(label = current_propertyLabel,
